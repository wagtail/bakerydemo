...
(function () {
    ...
    const toggleEnabledState = editor => api => {
      const updateState = () => api.setDisabled(getAnchorElement(editor, editor.selection.getNode()) === null);
      updateState();
      return toggleState(editor, updateState);
    };
    const toggleUnlinkState = editor => api => {
      ...
      return toggleState(editor, e => api.setDisabled(!hasLinks$1(e.parents)));
    };
