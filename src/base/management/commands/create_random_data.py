...
from src.base.models import FooterText, HomePage, Person, StandardPage
from src.blog.models import BlogIndexPage, BlogPage
from src.breads.models import (
    BreadIngredient,
    BreadPage,
    BreadsIndexPage,
    BreadType,
...
from src.locations.models import LocationPage, LocationsIndexPage
